...
"""
Copied from: https://github.com/GoogleCloudPlatform/notebooks-blueprint-security/blob/main/bootstrap_files/post_startup_script.sh
Disables nbconvert and local file downloading to prevent data exfiltration, as suggested in https://cloud.google.com/architecture/protecting-confidential-data-in-ai-platform-notebooks#ai_platform_notebooks_security_controls
"""
