...
| `ingress-deny-all`                     | ingress   | TODO              | TODO              | all                                                                                                                                                                                                                    | Need to add this still + test everything                                                                                                                                                                                                    |
...
| `egress-allow-tcp-git`                 | egress    | 65543             | `140.82.112.0/20` | `80, 443`                                                                                                                                                                                                              | Corresponding rule to `ingress-allow-tcp-git`.                                                                                                                                                                                              |
| `egress-allow-private-gcp-services`    | egress    | `199.36.153.8/30` | all               | Allow egress from instances on this network to the [IP range for `private.googleapis.com`](https://cloud.google.com/vpc/docs/configure-private-google-access-hybrid), which is only routable from within Google Cloud. |
| `egress-allow-restricted-gcp-services` | egress    | 65543             | `199.36.153.4/30` | all                                                                                                                                                                                                                    | TODO: this can probably be removed, assuming we use user managed instances in favour of gcp managed instances. Need to test this before removing.                                                                                           |
